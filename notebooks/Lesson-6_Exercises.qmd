...
```
#El valor p predictivo medio indica que es relativamente probable que el número de mujeres con 4 hijos observado en la muestra empírica pudiera haber ocurrido (no es muy extremo) bajo el modelo de distribución posterior.
:::
